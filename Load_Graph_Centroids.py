...
def load_data():
    ...
    print('Adding Time of departure and arrivals... ')
    ...
    print("Creating relations between 'PRECEDES' and 'Stoptimes'... ")
    ...
    print("Creating 'inter_time' properties on PRECEDES relations... ")
    ...
    print("Creating relations between LOCATED_AT and their properties 'inter_time'...")
    ...
    print("Adding centroid departure times...")
    ...
    print("Creating relations between WALK and their properties...")
