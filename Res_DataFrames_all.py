...
########################################################################
directory_res_all = "res_{}_{}DRT_all.txt".format(h_str, nb_DRT)
dir_path = os.path.join("./Results_{}/res".format(Data), directory_res_all)
old_directory_res_all = "res_{}_{}DRT_old.txt".format(h_str, nb_DRT)
...
print("Done !")
path_res = os.path.normpath("./Results_{}/res/res_{}_{}DRT_all.txt".format(Data, h_str, nb_DRT))
